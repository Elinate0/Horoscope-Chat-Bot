...
helloThereInputs = (
"hello", "hi", "greetings", "hey", "hola", "merhaba", "bonjour", "sua s’dei", "hallo", "ciao", "selam")
...
def greetings(hti, htr):
    ...
    time.sleep(1)
    print(
        "{0} Umarım kızmazsın fakat şu anda yalnızca boğa, ikizler, yengeç ve aslan burçları hakkında yorum yapabiliyorum.".format(
            prjName))
...
def loopHoroscope(smp):
    ...
    if userInput in helloThereInputs:
        ...
        match userInput:
            ...
            case "2":
                ...
                questions_sample.baseQuestionsShow(questions_sample.baseQuestionsTaurus,
                                                   questions_sample.baseAnswersTaurus)
                time.sleep(1)
                return loopHoroscope("taurus")
            case "3":
        ...
        match userInput:
            ...
            case "2":
                time.sleep(0.80)
                questions_sample.baseQuestionsShow(questions_sample.baseQuestionsCancer,
                                                   questions_sample.baseAnswersCancer)
                time.sleep(1)
                return loopHoroscope("cancer")
            case "3":
        ...
        match userInput:
            ...
            case "2":
                time.sleep(0.80)
                questions_sample.baseQuestionsShow(questions_sample.baseQuestionsGemini,
                                                   questions_sample.baseAnswersGemini)
                time.sleep(1)
                return loopHoroscope("gemini")
            case "3":
...
while readyForMove == False:
    ...
    if userInput.lower() in horoscopes:
        ...
        print(
            "{} Üzgünüm fakat bu burç hakkında yorum yapamıyorum. Söylemiş olduğum dört burç arasından birisini yazar mısın?".format(
                prjName))
    else:
